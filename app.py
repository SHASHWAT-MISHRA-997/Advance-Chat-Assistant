...
if input_method == "Text":
    ...
    # Automatically process input when Enter is pressed (for text input)
    if user_input:
        if user_input.strip() != "":
            ...
            # Show the bot's response and speak it
    ...
    # Create a single row with a button to recognize speech
    ...
    # Optional: Display the recognized input in a text area for confirmation
    if user_input:
        st.text_area("Recognized Input:", user_input, height=100)
